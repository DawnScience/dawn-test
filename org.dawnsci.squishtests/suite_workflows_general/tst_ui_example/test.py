...
def main():
    ...
    type(waitForObject(":Set Values_Text"), "fred")
    ...
    type(waitForObject(":Set Values_Text"), "<Ctrl+Shift+Right>")
    type(waitForObject(":Set Values_Text"), "<Ctrl+Shift+Right>")
    type(waitForObject(":Set Values_Text"), "opid1454")
    ...
    mouseClick(waitForObject(":Set Values_Text"), 205, 14, 0, Button.Button1)
    type(waitForObject(":Set Values_Text"), "<Ctrl+Shift+Left>")
    type(waitForObject(":Set Values_Text"), "<Ctrl+Shift+Left>")
    type(waitForObject(":Set Values_Text"), "<Ctrl+Shift+Left>")
    type(waitForObject(":Set Values_Text"), "<Ctrl+Shift+Left>")
    type(waitForObject(":Set Values_Text"), "opid144_1_789.img")
