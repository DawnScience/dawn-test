...
def main():
    ...
    #invert xaxis
    mouseClick(waitForObject(":Configure Settings..._ToolItem_5"), 5, 9, 0, Button.Button1)
    ...
    test.verify(lower=="2048.0", "XAxis minimum has been changed successfully")
    clickButton(waitForObject(":Configure Graph Settings.OK_Button"))
    snooze(1)
    
    #invert yaxis
    mouseClick(waitForObject(":Configure Settings..._ToolItem_5"), 9, 8, 0, Button.Button1)
    clickTab(waitForObject(":Configure Graph Settings.Axes_TabItem"))
    ...
    widget = findObject(":Change Settings.Minimum: _Text")
    lower = widget.text
    test.verify(upper=="2048.0", "YAxis maximum has been changed successfully")
    test.verify(lower=="0.0", "YAxis minimum has been changed successfully")
    clickButton(waitForObject(":Configure Graph Settings.OK_Button"))
    snooze(1)

    #revert inversion of xaxis
    mouseClick(waitForObject(":Configure Settings..._ToolItem_5"), 12, 1, 0, Button.Button1)
    clickTab(waitForObject(":Configure Graph Settings.Axes_TabItem"))
    clickButton(waitForObject(":Change Settings.Invert Axis_Button"))
    clickButton(waitForObject(":Configure Graph Settings.OK_Button"))
    #check that the min and max have been changed
    ...
    widget = findObject(":Change Settings.Minimum: _Text")
    lower = widget.text
    test.verify(upper=="2048.0", "XAxis maximum has been changed successfully")
    test.verify(lower=="0.0", "XAxis minimum has been changed successfully")
    clickButton(waitForObject(":Configure Graph Settings.OK_Button"))
    snooze(1)

    #revert inversion of yaxis
    mouseClick(waitForObject(":Configure Settings..._ToolItem_5"), 11, 7, 0, Button.Button1)
    clickTab(waitForObject(":Configure Graph Settings.Axes_TabItem"))
    mouseClick(waitForObjectItem(":Select Axis_Combo", "(Y-Axis)"), 0, 0, 0, Button.NoButton)
    clickButton(waitForObject(":Change Settings.Invert Axis_Button"))
    clickButton(waitForObject(":Configure Graph Settings.OK_Button"))
    ...
    test.verify(lower=="2048.0", "YAxis minimum has been changed successfully")
    clickButton(waitForObject(":Configure Graph Settings.OK_Button"))
