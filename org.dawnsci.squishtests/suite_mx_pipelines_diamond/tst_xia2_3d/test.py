...
def main():
    ...
    deleteOldLogFiles("EDApplicationSCXDAPXia2Commandline*")
...
#   Create a data project in the Project Explorer:
    ...
    clickButton(waitForObject(":Controls.xia2 3d_Button"))
    ...
    logfile = findLogFile("EDApplicationSCXDAPXia2Commandline*", 100)
    ...
    checkLogFile(wdir + '/' + logfile, 'Xia2 successful', 1800)
